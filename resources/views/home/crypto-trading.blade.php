@include('home.header')
<div class="crypto-trading-main py-5 bg-black">
    <div class="container">
        ...
        <div class="crypto-trading-content-section section">
            <p class="crypto-trading-section-text">
                Cytopia Capital is excited to announce the launch of our new cryptocurrency trading platform.
                Now you can
                ...
                fast deposits and withdrawals. Our support team is available 24/7/365 to help get you trading on our
                CySEC-regulated platform with a trading volume of US $11 billion monthly.
            </p>

            <h5 class="crypto-trading-section-title">What is a Cryptocurrency?</h5>
            <p class="crypto-trading-section-text">
            ...
            <h5 class="crypto-trading-section-title">How Do Cryptocurrencies Work?</h5>
            <p class="crypto-trading-section-text">
            ...
            <h5 class="crypto-trading-section-title">Are There Investment Opportunities with Cryptocurrencies?</h5>
            <p class="crypto-trading-section-text">
