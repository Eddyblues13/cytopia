...
<head>
    ...
    <title>Cytopia Capital - Learn to Invest</title>
    ...
    <div class="sidebar offcanvas offcanvas-start" tabindex="-1" id="sidebar" data-bs-scroll="true"
        ...
        <div class="profile-section mb-0 d-flex">
            <div class="d-block align-items-center text-center gap-3">
                <div class="profile-image py-1"><img src="{{asset('assets/img/logo.png')}}" alt=""></div>
            </div>
        ...
        <div class="nav-section mt-0">
            <div class="nav-section-title">
                ...
                <span class="px-2 text-white">Light</span>
            </div>
        </div>
        ...
        <div class="nav-section mt-0">
            <div class="nav-section-title">
                ...
                <span class="px-2"><a href="{{url('/')}}" class="text-white">Home</a></span>
            </div>
        </div>
        ...
        <div class="nav-section mt-0">
            <div class="nav-section-title">
                ...
                <span class="px-2"><a href="{{url('login')}}" class="text-white">Sign In</a></span>
            </div>
        </div>
        <div class="nav-section mt-0">
            <div class="nav-section-title">
                ...
                <span class="px-2"><a href="{{route('register')}}" class="text-white">Sign Up</a></span>
            </div>
        </div>
        <div class="nav-section mt-0">
            <div class="nav-section-title">
                ...
                <span class="px-2"><a href="{{url('contact')}}" class="text-white">Contact</a></span>
            </div>
        </div>
        <div class="nav-section mt-0">
            <div class="nav-section-title">
                ...
                <span class="px-2"><a href="{{url('about')}}" class="text-white">About Us</a></span>
            </div>
        </div>
        <!-- Additional Links -->
        <div class="nav-section mt-0">
            <div class="nav-section-title">
                <svg xmlns="http://www.w3.org/2000/svg" height="23px" viewBox="0 -960 960 960" width="23px" fill="#fff">
                    <path
                        d="M240-160q-33 0-56.5-23.5T160-240v-480q0-33 23.5-56.5T240-800h480q33 0 56.5 23.5T800-720v480q0 33-23.5 56.5T720-160H240Zm0-80h480v-480H240v480Zm240-240q-50 0-85-35t-35-85q0-50 35-85t85-35q50 0 85 35t35 85q0 50-35 85t-85 35ZM240-240v-480 480Z" />
                </svg>
                <span class="px-2"><a href="{{url('copy-trade')}}" class="text-white">Copy Trade</a></span>
            </div>
        </div>
        ...
        <div class="nav-section mt-0">
            <div class="nav-section-title">
                ...
                <span class="px-2"><a href="{{url('cookie-policy')}}" class="text-white">Cookie Policy</a></span>
            </div>
        </div>
        ...
        <div class="nav-section mt-0">
            <div class="nav-section-title">
                ...
                <span class="px-2"><a href="{{url('crypto-mining')}}" class="text-white">Crypto Mining</a></span>
            </div>
        </div>
        ...
        <div class="nav-section mt-0">
            <div class="nav-section-title">
                ...
                <span class="px-2"><a href="{{url('forex-trading')}}" class="text-white">Forex Trading</a></span>
            </div>
        </div>
        ...
        <div class="nav-section mt-0">
            <div class="nav-section-title">
                ...
                <span class="px-2"><a href="{{url('privacy-policy')}}" class="text-white">Privacy Policy</a></span>
            </div>
        </div>
        ...
        <div class="nav-section mt-0">
            <div class="nav-section-title">
                ...
                <span class="px-2"><a href="{{url('bitcoin-mining')}}" class="text-white">Bitcoin Mining</a></span>
            </div>
        </div>
        ...
        <div class="nav-section mt-0">
            <div class="nav-section-title">
                ...
                <span class="px-2"><a href="{{url('crypto-trading')}}" class="text-white">Crypto Trading</a></span>
            </div>
        </div>
        ...
        <div class="nav-section mt-0">
            <div class="nav-section-title">
                ...
                <span class="px-2"><a href="{{url('stocks-trading')}}" class="text-white">Stocks Trading</a></span>
            </div>
        </div>
        ...
        <div class="nav-section mt-0">
            <div class="nav-section-title">
                ...
                <span class="px-2"><a href="{{url('dogecoin-mining')}}" class="text-white">Dogecoin Mining</a></span>
            </div>
        </div>
