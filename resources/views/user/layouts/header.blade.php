...
<body>
    ...
    <div class="top-nav">
        <div class="d-flex">
            ...
            <div class="mt-1"><a href="#" class="text-decoration-none text-white">Cytopia Capital</a></div>
        </div>
    ...
    <div class="sidebar offcanvas offcanvas-start" tabindex="-1" id="sidebar" data-bs-scroll="true"
        ...
        <div class="nav-section mt-0">
            <div class="nav-section-title">
                ...
                <span class="px-2"><a href="{{route('trading')}}">Trading</a></span>
            </div>
        </div>
        <div class="nav-section mt-0">
            <div class="nav-section-title">
                ...
                <span class="px-2"><a href="{{route('holding')}}">Holding</a></span>
            </div>
        </div>
        <div class="nav-section mt-0">
            <div class="nav-section-title">
                ...
                <span class="px-2"><a href="{{route('staking')}}">Staking</a></span>
            </div>
        </div>
        <div class="nav-section mt-0">
            <div class="nav-section-title">
                ...
                <span class="px-2"><a href="{{route('account.index')}}">Account</a></span>
            </div>
        </div>
        <div class="nav-section mt-0">
            <div class="nav-section-title">
        ...
        <div class="nav-section mt-0">
            <div class="nav-section-title">
                ...
                <span class="px-2"><a href="{{route('withdrawal')}}">Withdrawals</a></span>
            </div>
        </div>
        <div class="nav-section mt-0">
            <div class="nav-section-title">
                ...
                <span class="px-2"><a href="{{route('copy.trade')}}">Copy Trading</a></span>
            </div>
        </div>
    </div>